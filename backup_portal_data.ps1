...
$BASETABLES='(addresses|companies|identity_providers|company_identity_providers|iam_identity_providers|apps|app_detail_images|app_tags|app_languages|agreements|agreement_assigned_apps|agreement_assigned_company_roles|document_templates|agreement_assigned_document_templates|iam_clients|user_roles|user_role_descriptions|app_instances|app_licenses|app_assigned_licenses|app_assigned_use_cases|app_descriptions|company_applications|company_assigned_apps|company_assigned_roles|company_assigned_use_cases|company_users|company_user_assigned_app_favourites|company_user_assigned_business_partners|company_user_assigned_roles|documents|consents|iam_users|invitations|connectors|company_service_accounts|notifications|app_assigned_documents)'

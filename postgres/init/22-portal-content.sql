...
ALTER TABLE portal.addresses DISABLE TRIGGER ALL;
...
ALTER TABLE portal.addresses ENABLE TRIGGER ALL;

--
-- Data for Name: companies; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.companies DISABLE TRIGGER ALL;

COPY portal.companies (id, date_created, business_partner_number, tax_id, name, shortname, company_status_id, address_id, self_description_document_id) FROM stdin;
2dc4249f-b5ca-4d42-bef1-7a7a950a4f87	2022-03-24 18:01:33.306+00	BPNL00000003CRHK	0000000000	Catena-X	Catena-X	2	b4db3945-19a7-4a50-97d6-e66e8dfd04fb	\N
ac861325-bc54-4583-bcdc-9e9f2a38ff84	2022-03-24 18:01:33.341+00	BPNL00000003AYRE	0000000000	Bayerische Motorenwerke AG	BMW AG	2	12302f9b-418c-4b8c-aea8-3eedf67e6a02	\N
0dcd8209-85e2-4073-b130-ac094fb47106	2022-03-24 18:01:33.344+00	BPNL00000003LLHA	0000000000	SAP AG	SAP	1	3a52099d-4988-4a56-9787-10a669c41338	\N
220330ac-170d-4e22-8d72-9467ed042149	2022-03-24 18:01:33.393+00	BPNL00000001LLHA	0000000000	Car Factory 1	Car Factory 1	1	aa49c0ec-4e65-4115-a01c-7adfc36d220e	\N
...
41fd2ab8-71cd-4546-9bef-a388d91b2542	2022-03-24 18:01:33.438+00	BPNL00000003LLHA	0000000000	Car Factory 3	Car Factory 3	1	86da3e1c-a634-41a6-ad44-9880746123e4	\N
...
3390c2d7-75c1-4169-aa27-6ce00e1f3cdd	2022-10-01 00:00:00+00	BPNL07800HZ01643	0000000000	Service Provider	SP	2	081c8bfd-c6d1-4119-a5f8-a69726dfc11e	\N
\.


ALTER TABLE portal.companies ENABLE TRIGGER ALL;

--
-- Data for Name: agreements; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.agreements DISABLE TRIGGER ALL;
...
ALTER TABLE portal.agreements ENABLE TRIGGER ALL;

--
-- Data for Name: agreement_assigned_company_roles; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.agreement_assigned_company_roles DISABLE TRIGGER ALL;
...
ALTER TABLE portal.agreement_assigned_offer_types ENABLE TRIGGER ALL;

--
-- Data for Name: offers; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.offers DISABLE TRIGGER ALL;
...
ALTER TABLE portal.offers ENABLE TRIGGER ALL;
...
ALTER TABLE portal.agreement_assigned_offers ENABLE TRIGGER ALL;

--
-- Data for Name: app_assigned_use_cases; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.app_assigned_use_cases DISABLE TRIGGER ALL;
...
ALTER TABLE portal.app_assigned_use_cases ENABLE TRIGGER ALL;

--
-- Data for Name: iam_clients; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.iam_clients DISABLE TRIGGER ALL;
...
ALTER TABLE portal.iam_clients ENABLE TRIGGER ALL;

--
-- Data for Name: app_instances; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.app_instances DISABLE TRIGGER ALL;
...
ALTER TABLE portal.app_instances ENABLE TRIGGER ALL;

--
-- Data for Name: app_languages; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.app_languages DISABLE TRIGGER ALL;
...
ALTER TABLE portal.app_languages ENABLE TRIGGER ALL;

--
-- Data for Name: offer_subscriptions; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.offer_subscriptions DISABLE TRIGGER ALL;
...
ALTER TABLE portal.offer_subscriptions ENABLE TRIGGER ALL;
...
ALTER TABLE portal.audit_company_application20221005 DISABLE TRIGGER ALL;
...
ALTER TABLE portal.audit_company_application20221005 ENABLE TRIGGER ALL;

--
-- Data for Name: audit_company_user20221005; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.audit_company_user20221005 DISABLE TRIGGER ALL;
...
ALTER TABLE portal.audit_company_user20221005 ENABLE TRIGGER ALL;

--
-- Data for Name: audit_company_user_assigned_role20221005; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.audit_company_user_assigned_role20221005 DISABLE TRIGGER ALL;
...
ALTER TABLE portal.audit_company_user_assigned_role20221005 ENABLE TRIGGER ALL;

--
-- Data for Name: audit_company_user_assigned_role20221018; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.audit_company_user_assigned_role20221018 DISABLE TRIGGER ALL;
...
ALTER TABLE portal.audit_company_user_assigned_role20221018 ENABLE TRIGGER ALL;

--
-- Data for Name: audit_offer20221013; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.audit_offer20221013 DISABLE TRIGGER ALL;
...
ALTER TABLE portal.audit_offer20221013 ENABLE TRIGGER ALL;

--
-- Data for Name: audit_offer_subscription20221005; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.audit_offer_subscription20221005 DISABLE TRIGGER ALL;
...
ALTER TABLE portal.audit_offer_subscription20221005 ENABLE TRIGGER ALL;

--
-- Data for Name: audit_user_role20221017; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.audit_user_role20221017 DISABLE TRIGGER ALL;

COPY portal.audit_user_role20221017 (audit_v1id, id, user_role, offer_id, last_editor_id, audit_v1last_editor_id, audit_v1operation_id, audit_v1date_last_changed) FROM stdin;
\.


ALTER TABLE portal.audit_user_role20221017 ENABLE TRIGGER ALL;

--
-- Data for Name: company_applications; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.company_applications DISABLE TRIGGER ALL;
...
ALTER TABLE portal.company_applications ENABLE TRIGGER ALL;

--
-- Data for Name: company_assigned_roles; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.company_assigned_roles DISABLE TRIGGER ALL;
...
ALTER TABLE portal.company_assigned_roles ENABLE TRIGGER ALL;

--
-- Data for Name: company_assigned_use_cases; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.company_assigned_use_cases DISABLE TRIGGER ALL;
...
ALTER TABLE portal.identity_providers ENABLE TRIGGER ALL;

--
-- Data for Name: company_identity_providers; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.company_identity_providers DISABLE TRIGGER ALL;
...
ALTER TABLE portal.company_service_accounts DISABLE TRIGGER ALL;
...
ALTER TABLE portal.company_service_accounts ENABLE TRIGGER ALL;

--
-- Data for Name: company_users; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.company_users DISABLE TRIGGER ALL;
...
ALTER TABLE portal.company_users ENABLE TRIGGER ALL;

--
-- Data for Name: company_user_assigned_app_favourites; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.company_user_assigned_app_favourites DISABLE TRIGGER ALL;
...
ALTER TABLE portal.company_user_assigned_app_favourites ENABLE TRIGGER ALL;

--
-- Data for Name: company_user_assigned_business_partners; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.company_user_assigned_business_partners DISABLE TRIGGER ALL;
...
ALTER TABLE portal.company_user_assigned_business_partners ENABLE TRIGGER ALL;

--
-- Data for Name: user_roles; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.user_roles DISABLE TRIGGER ALL;

COPY portal.user_roles (id, user_role, offer_id, last_editor_id) FROM stdin;
7410693c-c893-409e-852f-9ee886ce94a6	Company Admin	9ef01c20-6d9d-41ef-b336-fa64e1e2e4c2	\N
7410693c-c893-409e-852f-9ee886ce94a7	Legal Admin	9ef01c20-6d9d-41ef-b336-fa64e1e2e4c2	\N
...
aabcdfeb-6669-4c74-89f0-19cda0908730	EarthCommerce.Content.ManagerRC_QAS2	ac1cf001-7fbc-1f2f-817f-bce05744000b	\N
aabcdfeb-6669-4c74-89f0-19cda0908731	EarthCommerce.UserRC_QAS2	ac1cf001-7fbc-1f2f-817f-bce05744000b	\N
b05d86e1-6c98-4619-85fa-9a425e0800b6	Business Admin	9b957704-3505-4445-822c-d7ef80f27fcd	\N
b05d86e1-6c98-4619-85fa-9a425e080000	fraud_app_manager	f9cad59d-84b3-4880-a550-4072c26a6b93	\N
b05d86e1-6c98-4619-85fa-9a425e080001	fraud_app_user	f9cad59d-84b3-4880-a550-4072c26a6b93	\N
b05d86e1-6c98-4619-85fa-9a425e080002	fraud_app_manager	f9cad59d-84b3-4880-a550-4072c26a6b94	\N
b05d86e1-6c98-4619-85fa-9a425e080003	fraud_app_user	f9cad59d-84b3-4880-a550-4072c26a6b94	\N
855eeefb-a2ef-4d74-ac10-34a87afcb865	admin	5cf74ef8-e0b7-4984-a872-474828beb5d3	\N
545c2616-2fce-4f52-b881-331db2fc1e35	customer	5cf74ef8-e0b7-4984-a872-474828beb5d3	\N
7a9e0777-2b13-4463-a7c4-f699afff3527	oem	5cf74ef8-e0b7-4984-a872-474828beb5d3	\N
b05d86e1-6c98-4619-85fa-9a425e080004	Buyer	5cf74ef8-e0b7-4984-a872-474828beb5d5	\N
b05d86e1-6c98-4619-85fa-9a425e080005	Supplier	5cf74ef8-e0b7-4984-a872-474828beb5d5	\N
b05d86e1-6c98-4619-85fa-9a425e080006	Buyer	5cf74ef8-e0b7-4984-a872-474828beb5d6	\N
b05d86e1-6c98-4619-85fa-9a425e080007	Supplier	5cf74ef8-e0b7-4984-a872-474828beb5d6	\N
b05d86e1-6c98-4619-85fa-9a425e080008	Administrator	5cf74ef8-e0b7-4984-a872-474828beb5d4	\N
b05d86e1-6c98-4619-85fa-9a425e080009	User	5cf74ef8-e0b7-4984-a872-474828beb5d4	\N
b05d86e1-6c98-4619-85fa-9a425e080010	Viewer	5cf74ef8-e0b7-4984-a872-474828beb5d4	\N
b05d86e1-6c98-4619-85fa-9a425e080011	Modifier	5cf74ef8-e0b7-4984-a872-474828beb5d4	\N
b05d86e1-6c98-4619-85fa-9a425e080012	Network Owner	5cf74ef8-e0b7-4984-a872-474828beb5d7	\N
b05d86e1-6c98-4619-85fa-9a425e080013	Network Participant	5cf74ef8-e0b7-4984-a872-474828beb5d7	\N
b05d86e1-6c98-4619-85fa-9a425e080014	Data Contributor	5cf74ef8-e0b7-4984-a872-474828beb5d7	\N
607818be-4978-41f4-bf63-fa8d2de51155	Digital Twin Management	0ffcb416-1101-4ba6-8d4a-a9dfa31745a4	\N
607818be-4978-41f4-bf63-fa8d2de51156	Semantic Model Management	0ffcb416-1101-4ba6-8d4a-a9dfa31745a4	\N
607818be-4978-41f4-bf63-fa8d2de51157	Wallet Management	0ffcb416-1101-4ba6-8d4a-a9dfa31745a4	\N
607818be-4978-41f4-bf63-fa8d2de51158	Buyer	5cf74ef8-e0b7-4984-a872-474828beb5d8	\N
607818be-4978-41f4-bf63-fa8d2de51159	Supplier	5cf74ef8-e0b7-4984-a872-474828beb5d8	\N
607818be-4978-41f4-bf63-fa8d2de51160	Buyer	5cf74ef8-e0b7-4984-a872-474828beb5d9	\N
607818be-4978-41f4-bf63-fa8d2de51161	Supplier	5cf74ef8-e0b7-4984-a872-474828beb5d9	\N
607818be-4978-41f4-bf63-fa8d2de51162	BPDM Management	0ffcb416-1101-4ba6-8d4a-a9dfa31745a4	\N
607818be-4978-41f4-bf63-fa8d2de51163	BPDM Partner Gate	0ffcb416-1101-4ba6-8d4a-a9dfa31745a4	\N
607818be-4978-41f4-bf63-fa8d2de51164	DAPS Certificate Management	0ffcb416-1101-4ba6-8d4a-a9dfa31745a4	\N
607818be-4978-41f4-bf63-fa8d2de51165	Dataspace Discovery	0ffcb416-1101-4ba6-8d4a-a9dfa31745a4	\N
607818be-4978-41f4-bf63-fa8d2de51166	Company Admin	5cf74ef8-e0b7-4984-a872-474828beb510	\N
...
ALTER TABLE portal.user_roles ENABLE TRIGGER ALL;

--
-- Data for Name: company_user_assigned_roles; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.company_user_assigned_roles DISABLE TRIGGER ALL;
...
ALTER TABLE portal.company_user_assigned_roles ENABLE TRIGGER ALL;

--
-- Data for Name: documents; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.documents DISABLE TRIGGER ALL;
...
ALTER TABLE portal.documents ENABLE TRIGGER ALL;
...
ALTER TABLE portal.connectors ENABLE TRIGGER ALL;

--
-- Data for Name: consents; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.consents DISABLE TRIGGER ALL;
...
ALTER TABLE portal.iam_identity_providers ENABLE TRIGGER ALL;

--
-- Data for Name: iam_users; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.iam_users DISABLE TRIGGER ALL;
...
ALTER TABLE portal.iam_users ENABLE TRIGGER ALL;

--
-- Data for Name: invitations; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.invitations DISABLE TRIGGER ALL;
...
ALTER TABLE portal.invitations ENABLE TRIGGER ALL;

--
-- Data for Name: notifications; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.notifications DISABLE TRIGGER ALL;
...
ALTER TABLE portal.notifications ENABLE TRIGGER ALL;

--
-- Data for Name: offer_assigned_documents; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.offer_assigned_documents DISABLE TRIGGER ALL;
...
ALTER TABLE portal.offer_assigned_documents ENABLE TRIGGER ALL;

--
-- Data for Name: offer_licenses; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.offer_licenses DISABLE TRIGGER ALL;
...
ALTER TABLE portal.offer_licenses ENABLE TRIGGER ALL;

--
-- Data for Name: offer_assigned_licenses; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.offer_assigned_licenses DISABLE TRIGGER ALL;
...
ALTER TABLE portal.offer_assigned_licenses ENABLE TRIGGER ALL;

--
-- Data for Name: offer_descriptions; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.offer_descriptions DISABLE TRIGGER ALL;
...
ALTER TABLE portal.offer_descriptions ENABLE TRIGGER ALL;

--
-- Data for Name: offer_detail_images; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.offer_detail_images DISABLE TRIGGER ALL;
...
ALTER TABLE portal.offer_detail_images ENABLE TRIGGER ALL;

--
-- Data for Name: offer_tags; Type: TABLE DATA; Schema: portal; Owner: portal
--

ALTER TABLE portal.offer_tags DISABLE TRIGGER ALL;
...
ALTER TABLE portal.user_role_descriptions DISABLE TRIGGER ALL;
...
ALTER TABLE portal.user_role_descriptions ENABLE TRIGGER ALL;
